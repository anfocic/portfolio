...
import { IslandProps } from "../pages/Home";
...
const Island: React.FC<IslandProps> = (
    ...
    const islandRef: React.Ref<any> = useRef();
    ...
    const lastX: MutableRefObject<number> = useRef(0);
    const rotationSpeed: MutableRefObject<number> = useRef(0);
    ...
    const handlePointerUp = (e: any): void => {
        e.stopPropagation();
        e.preventDefault();
        setIsRotating(false);
    }
    ...
    useEffect(() => {
        ...
        islandRef.current.position.z = -105;
